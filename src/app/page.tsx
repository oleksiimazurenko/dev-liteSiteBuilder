...
export default async function Home() {
  ...
  return (
    <div className="sm:items-baseline bcw1 dark:bcd1 relative grid min-h-screen w-screen min-w-[300px] grid-cols-[1fr] grid-rows-[6fr_1fr] justify-center p-[20px] sm:grid-cols-[1fr] md:grid-cols-[1fr_2fr] md:grid-rows-1">
      <AuthPanel />
